...
# aonverting to datetime and setting as index
...
# converting columns that should be numeric but are typed as 'object'
for col in non_numeric_columns:
    solar_data[col] = pd.to_numeric(solar_data[col], errors='coerce')

# attempting to resample again
